...
exports.handler = function (notification, context, callback) {
    ...
    // Configure SSH param variables for use below:
    ...
    function stageObjFromS3() {
        ...
        // If s3 object acquired, call useObjFromS3 to SSH with it.
        promise.then(
            function(data) {
    ...
    function sshAndRunScript(data) {
        ...
        // For actual script... use ssh.on "close" to call separate function
        // That includes call to complete termination policy ;)
